...
Revision ID: c113c0b2729f
Revises: 
Create Date: 2024-06-17 02:00:44.415315
...
def upgrade():
    ...
    op.create_table('housing_price_data',
    sa.Column('id', sa.Integer(), nullable=False),
    sa.Column('year', sa.Integer(), nullable=False),
...
def downgrade():
    ...
    op.drop_table('pension_data')
    op.drop_table('inflation')
    op.drop_table('housing_price_data')
    op.drop_table('gdp')
    # ### end Alembic commands ###
